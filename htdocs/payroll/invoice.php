      ...
      <div class="card card-width mx-auto mt-5">
       <div class= "card card-header ">
        ...
        <div class="card-body">
          ...
          <?php if ($stype == 1) { ?>
          <h4>Basic : <?php echo $basic;?> Rs. </h4>
          <h4>Expense : <?php echo $medical_expense;?> Rs.</h4>
          <h4>Tax : <?php echo $tax;?> Rs.</h4>
          <h4>Total Deductions : <?php echo $total_deductions;?> Rs.</h4>
          <h4>Salary Paid : <?php echo $paid;?> Rs.</h4>
          <?php }  elseif ($stype == 2) {?>
            

          <h4>Hour Rate : <?php echo $hour_rate;?> </h4>
          <h4>Hours Worked : <?php echo $hours;?> </h4>
          <h4>Salary Paid : <?php echo $paid1;?> Rs.</h4>
          <?php } ?>
